...
rule's locations or fields change. Persisting a Known Source Rule identity would
follow path overrides and rule updates automatically, but it would also make an
