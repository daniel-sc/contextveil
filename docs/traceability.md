...
| INT-002 | Explain an empty detected-harness list and do not offer an undetected, not-yet-managed harness | src/setup/integrations.rs (`render_rows`, visibility filter) | tests/setup.rs::an_undetected_harness_is_not_offered | covered |
